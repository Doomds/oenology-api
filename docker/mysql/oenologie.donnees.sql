...
--
CREATE DATABASE IF NOT EXISTS `oenologie`;
USE `oenologie`;
...
-- Mot de passe: `mZTbURtCucb92Grf`
--
DROP USER IF EXISTS 'u_oenologue'@'localhost';
CREATE USER 'u_oenologue'@'localhost' IDENTIFIED WITH caching_sha2_password BY 'mZTbURtCucb92Grf';
GRANT USAGE ON *.* TO 'u_oenologue'@'localhost';
ALTER USER 'u_oenologue'@'localhost' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;
GRANT SELECT, INSERT, UPDATE, DELETE, EXECUTE ON `oenologie`.* TO 'u_oenologue'@'localhost';
ALTER USER 'u_oenologue'@'localhost';
-- --------------------------------------------------------
...
--
ALTER TABLE `avis`
 ADD PRIMARY KEY (`id`), ADD KEY `ref_oenologue` (`ref_oenologue`), ADD KEY `ref_vin` (`ref_vin`), ADD UNIQUE KEY `ref_oenologue_ref_vin` (`ref_oenologue`,`ref_vin`);
